...
// iOS-style bottom sheet for picking a category. Direction (In/Out) lives at the
// top and filters the grid; tapping a category selects it and dismisses.
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            onClick={onClose}
          />
          {/* Sheet — matches the app's max-w-md column, slides up from the bottom. */}
          <motion.div
