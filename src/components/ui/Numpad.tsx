      ...
      {KEYS.map((k) =>
        k === "⌫" ? (
          <button
            ...
            className="press rounded-card bg-grouped py-4 font-display text-2xl font-semibold tabular-nums text-carrot-dark transition active:bg-carrot-soft"
          >
            {k}
          </button>
        ) : (
          <button
            ...
            type="button"
            onClick={() => handle(k)}
            className="press rounded-card bg-grouped py-4 font-display text-2xl font-semibold tabular-nums text-label transition active:bg-carrot-soft"
          >
            {k}
          </button>
        ),
