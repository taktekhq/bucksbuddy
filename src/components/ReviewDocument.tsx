...
// A finished spending review, rendered field by field, in the review screen's
// own dark palette (see tailwind.config.ts and DESIGN_SYSTEM.md) — cards get a
  ...
  return (
    <article className="flex flex-col gap-4">
      ...
      {review.caveats.length > 0 && (
        <div className="flex flex-col gap-2">
          <SectionHeader className="text-review-muted">What this review couldn&apos;t see</SectionHeader>
