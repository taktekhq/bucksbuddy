      ...
      <div className="flex items-center justify-between gap-3 px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            onBlur={commit}
            className="w-28 rounded-lg border border-separator px-3 py-2 text-right text-base tabular-nums text-label-secondary outline-none ring-carrot/40 transition focus:ring-2"
          />
        </div>
      </div>
    </div>
